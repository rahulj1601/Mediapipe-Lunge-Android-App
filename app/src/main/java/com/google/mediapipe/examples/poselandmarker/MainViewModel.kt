...
class MainViewModel : ViewModel() {
    ...
    private var _minPoseDetectionConfidence: Float = 0.85F
    private var _minPoseTrackingConfidence: Float = 0.85F
    private var _minPosePresenceConfidence: Float = 0.85F
